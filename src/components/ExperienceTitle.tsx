    ...
    return (
        <Section>
            <div className="flex flex-col gap-2 border-l-4 border-primary-100 pl-4">
                ...
                <h1 className="text-3xl md:text-6xl xl:text-7xl 2xl:text-8xl font-headline font-bold text-white tracking-wider leading-none">PROFESSIONAL<br /><span className="text-primary-100">EXPERIENCE</span></h1>
            </div>
        </Section>
    )
}