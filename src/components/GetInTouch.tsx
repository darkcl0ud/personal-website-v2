...
export default function GetInTouch() {
    ...
    return <Section>
        <div className="relative flex flex-col gap-8 items-center justify-center py-32">
            <div
                ...
                aria-hidden
            />
            <p className="text-primary-100 font-label font-extralight tracking-widest text-center">INITIALIZE CONNECTION</p>
            ...
            <p className="text-tertiary-100 font-extralight font-label tracking-widest text-center">AWAITING SYSTEM PROMPT...</p>
        </div>
    </Section>
}