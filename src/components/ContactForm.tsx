...
export default function ContactForm() {
    return (
        <Section>
            <form className="bg-black p-6 shadow-[0_0_12px_theme(colors.primary.100/50%),0_0_64px_theme(colors.primary.100/25%)] flex flex-col gap-8 font-label max-w-[600px] mx-auto">
